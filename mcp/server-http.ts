...
const tools: Tool[] = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        workspaceId: { type: "string", description: "工作区ID（如 project-a），不传则获取所有工作区" },
      },
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        workspaceId: { type: "string", description: "工作区ID（如 project-a），不传则创建在根目录" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        workspaceId: { type: "string", description: "工作区ID（用于修改任务所属工作区）" },
      },
      required: ["id"],
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        workspaceId: { type: "string", description: "工作区ID（可选）" },
        status: { type: "string", enum: ["all", "active", "completed"], description: "筛选状态" },
      },
      required: ["keyword"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        path: { type: "string", description: "工作区路径（已废弃，使用id）" },
